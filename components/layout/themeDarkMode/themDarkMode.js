    ...
    return (
        <>
            <div className="dark:text-gray-100 dark:bg-slate-900 min-h-screen p-10">
                <div className="fixed  bottom-5 right-10 dark:bg-slate-700 bg-gray-100 rounded-lg p-2 ">
                    <button
                        onClick={() => setTheme('dark')}
                        className={`${theme == 'dark' && 'text-sky-600'} text-black`}
                    >
                    ...
                    <button
                        ...
                        className={`${theme === 'light' && 'text-sky-600'} p-1 text-black`}
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                    ...
                    <button
                        ...
                        className={`${theme === 'system' && 'text-sky-600'} text-black`}
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
